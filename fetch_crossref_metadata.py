...
JOURNALS = {
    ...
    "Coordination Chemistry Reviews": ("0010-8545", "Review"),
    ...
    "ACS Organic & Inorganic Au": ("2694-2445", "Organic"),
...
def fetch_articles(issn, count):
    ...
    try:
        r = requests.get(url, params=params, headers={"User-Agent": "ChemPaperFeed/1.0 (mailto:your-email@example.com)"}, timeout=40)
        r.raise_for_status()
